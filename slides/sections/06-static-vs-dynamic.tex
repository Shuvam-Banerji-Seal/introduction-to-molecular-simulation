...
\begin{frame}{Geometry Optimization \& DFT}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{infobox}[DFT $\approx$ Exact for $U$, Still Static]
      \scriptsize No temperature \ensuremath{\rightarrow} no entropy \ensuremath{\rightarrow} free energy missing
    \end{infobox}
  \end{columns}
\end{frame}
...
\begin{frame}{Funnel TikZ}
  \begin{center}
    \begin{tikzpicture}[scale=0.9]
      ...
      \node[color=fgwhite] at (0,1) {funnel \ensuremath{\rightarrow} bias};
    \end{tikzpicture}
  \end{center}
\end{frame}
