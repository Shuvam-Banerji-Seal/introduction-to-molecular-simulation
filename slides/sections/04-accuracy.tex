  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{center}
      \begin{tikzpicture}[scale=1.0]
        ...
        \node[draw=neonpink,fill=neonpink!15,rounded corners=1mm,minimum width=2.6cm,minimum height=0.7cm] at (0,-0.5) {\color{neonpink}\footnotesize 0.1$_{10}$ = 0.000110011...$_2$};
      \end{tikzpicture}
    \end{center}
