...
\begin{frame}{MD Workflow --- From $\mathbf{r}_0$ to Trajectory}
	\begin{center}
		\begin{tikzpicture}[scale=1.0]
			...
			\node[draw=neonyellow,fill=neonyellow!15,rounded corners=1mm,inner sep=1.5mm,font=\footnotesize,text=bgblack] at (1.6,1.2) {IC: Maxwell--Boltzmann};
			\node[draw=neongreen,fill=neongreen!15,rounded corners=1mm,inner sep=1.5mm,font=\footnotesize,text=bgblack] at (4.8,1.2) {Equil. \ensuremath{\rightarrow} Prod.};
		\end{tikzpicture}
	\end{center}
	\begin{pitemize}
...
\begin{frame}{Convergence --- When to Stop?}
	\begin{columns}[T,onlytextwidth]
		...
		\begin{tikzpicture}[scale=1.0]
			...
			\draw[neongreen,thick] plot[smooth] coordinates {(0,1.0) (0.3,0.8) (0.6,0.6) (0.9,0.5) (1.2,0.45) (1.5,0.42) (1.8,0.41) (2.1,0.405) (2.4,0.4)};
