...
\begin{frame}{Entropy --- Counting}
	...
	\begin{columns}[T,onlytextwidth]
		...
		\column{0.5\textwidth}
		\begin{tikzpicture}[scale=1.0]
			\node[draw=accentcyan,fill=darkgray,rounded corners=1mm,minimum width=1.6cm,minimum height=0.7cm] (a) at (0,0) {\footnotesize $\Omega=1$};
			\node[draw=neonpink,fill=neonpink!15,rounded corners=1mm,minimum width=2.2cm,minimum height=0.7cm] (b) at (0,-1.1) {\footnotesize $\Omega=10^{23}$};
...
\begin{frame}{Ergodicity \& Ensemble Average}
	...
	\begin{columns}[T,onlytextwidth]
		...
		\begin{tikzpicture}[scale=1.0]
			...
			\node[color=bgblack] at (1.1,0.8) {trajectory};
