...
\begin{frame}{Realistic Figures --- Ball-and-Stick \& PES}
	\begin{columns}[T,onlytextwidth]
		\column{0.33\textwidth}
		\begin{center}
			\includegraphics[width=\linewidth]{assets/figures/ball_stick_water.png}
			{\footnotesize\color{softgray} H$_2$O: $\angle$ 104.5\textdegree, ball-and-stick}
		\end{center}
		\column{0.33\textwidth}
		\begin{center}
			\includegraphics[width=\linewidth]{assets/figures/ball_stick_benzene.png}
			{\footnotesize\color{softgray} Benzene: 6-membered ring}
		\end{center}
		\column{0.33\textwidth}
		\begin{center}
			\includegraphics[width=\linewidth]{assets/figures/pes_3d.png}
			{\footnotesize\color{softgray} PES: double well + saddle}
		\end{center}
	\end{columns}
\end{frame}

\begin{frame}{Realistic Figures --- Simulation Box \& PBC}
	\begin{columns}[T,onlytextwidth]
		\column{0.5\textwidth}
		\begin{center}
			\includegraphics[width=0.95\linewidth]{assets/figures/simulation_box.png}
			{\footnotesize\color{softgray} Cubic box, LJ fluid, PBC ghost images}
		\end{center}
		\column{0.5\textwidth}
		\begin{center}
			\includegraphics[width=0.9\linewidth]{assets/figures/pbc_schematic.png}
			{\footnotesize\color{softgray} Minimum image convention}
		\end{center}
	\end{columns}
\end{frame}
