		...
		\begin{center}
			\resizebox{\linewidth}{!}{%
				\begin{tikzpicture}[scale=0.75, every node/.style={font=\small}]
					...
					% Chip pins — only above and below the box, NOT through it
					\foreach \x in {-1.0,-0.5,0,0.5,1.0} {\draw[accentcyan,thick] (\x,3.3) -- (\x,3.6); \draw[accentcyan,thick] (\x,1.9) -- (\x,1.6);}
