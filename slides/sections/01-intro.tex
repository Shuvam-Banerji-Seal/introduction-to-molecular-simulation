	...
	\begin{columns}[T,onlytextwidth]
		...
		\begin{center}
			\begin{tikzpicture}[scale=1.1, every node/.style={font=\small}]
				% Chip with pins — larger fonts, MORE SPACING between nodes
				...
				\foreach \x in {-1.0,-0.5,0,0.5,1.0} {\draw[accentcyan,thick] (\x,3.25) -- (\x,1.9);}
				% Simulation — more gap below chip
				...
				% Observables — more gap below sim
				...
				% Arrows with labels — longer arrows with clear gaps
				...
				\only<2>{\node[draw=neonpink,fill=neonpink!12,rounded corners=2mm,inner sep=2.5mm,align=center] at (0,4.0) {\color{neonpink}\bfseries\small you control $\Delta t,\,T,\,P$!\\\color{fgwhite}\footnotesize\ttfamily dt, thermostat, barostat};}
				\only<3>{\node[draw=accentcyan,fill=accentcyan!10,rounded corners=1mm,inner sep=2mm,align=center] at (4.0,0.3) {\color{accentcyan}\footnotesize\bfseries $10^9$ steps $\to$ $1\,\mu$s};}
			\end{tikzpicture}
		\end{center}
	\end{columns}
\end{frame}
	...
	\begin{center}
		\begin{tikzpicture}[scale=1.0]
			...
			\begin{scope}[xshift=0cm]
				...
				\node[font=\bfseries,color=fgwhite] at (b0.north) {\footnotesize Wireframe};
			...
			\begin{scope}[xshift=2.6cm]
				...
				\node[font=\bfseries,color=fgwhite] at (b1.north) {\footnotesize Ball-Stick};
			...
			\begin{scope}[xshift=5.2cm]
				...
				\node[font=\bfseries,color=fgwhite] at (b2.north) {\footnotesize Space-fill};
			...
			\begin{scope}[xshift=7.8cm]
				...
				\node[font=\bfseries,color=fgwhite] at (b3.north) {\footnotesize Cartoon};
